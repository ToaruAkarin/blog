...
if (document.querySelector('.toc-bar')) {
    ...
    if (document.body.clientWidth >= '768' ) {
        ...
        siteFooter.style.paddingBottom = '60px';
    }
    ...
    window.addEventListener("resize", function(){
        ...
        if (document.body.clientWidth >= '768' ) {
            ...
            siteFooter.style.paddingBottom = '20px';
        } else {
            tocBar.style.top = '100%'
            siteFooter.style.paddingBottom = '60px';
        }
        tocMain.classList.add('collapsed')
    });
    ...
    tocSwitch.addEventListener('click', function(){
        ...
        window.requestAnimationFrame(function () {
            if (!tocMain.classList.contains('collapsed')) {
                if (document.body.clientWidth >= '768' ) {
                    tocBar.style.right = -newTocWidth + 'px'
                } else {
                    // 隐藏 toc
                ...
                tocMain.classList.remove('collapsed')
            }
        })
    });
